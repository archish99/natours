...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXJjaGlzaDk5IiwiYSI6ImNrYndjbHF4YjBlcG4yem5xeWZtc3l4ZGwifQ.U-tO277gMlcc2f7dy9f7mg';
  ...
  locations.forEach(function (loc) {
    ...
    }).setLngLat(loc.coordinates).addTo(map); // Add the popup (name)
...
var stripe = Stripe('pk_test_JBnqkvn30N0a5MsDOzr1hEks00BNyytMSC');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData(); // Creating new formData (multipart form data)
